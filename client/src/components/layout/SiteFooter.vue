<template lang="pug">
  ...
  footer#footer
    ...
    div#html.site-version(aria-label="Icons of the technology used on this site and link to Github")
      ...
      div
        img(alt="VueJS Icon" title="VueJS for the frontend framework" src="https://chriscorchado.com/images/vuejs.png")
      div
        img(alt="nodeJS Icon" title="nodeJS for the platform" src="https://chriscorchado.com/images/nodejs.png")
      div
        img(alt="Express Icon" title="Express for the backend framework" src="https://chriscorchado.com/images/express.png")
      div
      ...
      div
        img(alt="Pug Icon" title="Pug for the HTML content templates" src="https://chriscorchado.com/images/pugjs.png")
      div
